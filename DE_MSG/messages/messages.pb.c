...
const pb_field_t ApplySettings_fields[7] = {
    ...
    PB_FIELD(  5, ENUM    , OPTIONAL, STATIC  , OTHER, ApplySettings, passphrase_source, homescreen, 0),
...
const pb_field_t StellarGetPublicKey_fields[2] = {
    PB_FIELD(  1, UINT32  , REPEATED, STATIC  , FIRST, StellarGetPublicKey, address_n, address_n, 0),
    PB_LAST_FIELD
};

const pb_field_t StellarPublicKey_fields[2] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarPublicKey, public_key, public_key, 0),
    PB_LAST_FIELD
};

const pb_field_t StellarSignTx_fields[14] = {
    PB_FIELD(  1, UINT32  , OPTIONAL, STATIC  , FIRST, StellarSignTx, protocol_version, protocol_version, 0),
    PB_FIELD(  2, UINT32  , REPEATED, STATIC  , OTHER, StellarSignTx, address_n, protocol_version, 0),
    PB_FIELD(  3, STRING  , OPTIONAL, STATIC  , OTHER, StellarSignTx, network_passphrase, address_n, 0),
    PB_FIELD(  4, BYTES   , OPTIONAL, STATIC  , OTHER, StellarSignTx, source_account, network_passphrase, 0),
...
const pb_field_t StellarPaymentOp_fields[5] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarPaymentOp, source_account, source_account, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC  , OTHER, StellarPaymentOp, destination_account, source_account, 0),
...
const pb_field_t StellarCreateAccountOp_fields[4] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarCreateAccountOp, source_account, source_account, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC  , OTHER, StellarCreateAccountOp, new_account, source_account, 0),
...
const pb_field_t StellarPathPaymentOp_fields[8] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarPathPaymentOp, source_account, source_account, 0),
    ...
    PB_FIELD(  4, BYTES   , OPTIONAL, STATIC  , OTHER, StellarPathPaymentOp, destination_account, send_max, 0),
...
const pb_field_t StellarManageOfferOp_fields[8] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarManageOfferOp, source_account, source_account, 0),
...
const pb_field_t StellarCreatePassiveOfferOp_fields[7] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarCreatePassiveOfferOp, source_account, source_account, 0),
...
const pb_field_t StellarSetOptionsOp_fields[13] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarSetOptionsOp, source_account, source_account, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC  , OTHER, StellarSetOptionsOp, inflation_destination_account, source_account, 0),
...
const pb_field_t StellarChangeTrustOp_fields[4] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarChangeTrustOp, source_account, source_account, 0),
...
const pb_field_t StellarAllowTrustOp_fields[6] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarAllowTrustOp, source_account, source_account, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC  , OTHER, StellarAllowTrustOp, trusted_account, source_account, 0),
...
const pb_field_t StellarAccountMergeOp_fields[3] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarAccountMergeOp, source_account, source_account, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC  , OTHER, StellarAccountMergeOp, destination_account, source_account, 0),
    PB_LAST_FIELD
};

const pb_field_t StellarManageDataOp_fields[4] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarManageDataOp, source_account, source_account, 0),
...
const pb_field_t StellarBumpSequenceOp_fields[3] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, STATIC  , FIRST, StellarBumpSequenceOp, source_account, source_account, 0),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ApplySettings, homescreen) < 65536 && pb_membersize(Entropy, entropy) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SignMessage, message) < 65536 && pb_membersize(VerifyMessage, message) < 65536 && pb_membersize(CipherKeyValue, value) < 65536 && pb_membersize(CipheredKeyValue, value) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(EthereumSignTx, data_initial_chunk) < 65536 && pb_membersize(EthereumTxAck, data_chunk) < 65536 && pb_membersize(EthereumSignMessage, message) < 65536 && pb_membersize(EthereumVerifyMessage, message) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(SignIdentity, challenge_hidden) < 65536 && pb_membersize(GetECDHSessionKey, identity) < 65536 && pb_membersize(NEMSignTx, transaction) < 65536 && pb_membersize(NEMSignTx, multisig) < 65536 && pb_membersize(NEMSignTx, transfer) < 65536 && pb_membersize(NEMSignTx, provision_namespace) < 65536 && pb_membersize(NEMSignTx, mosaic_creation) < 65536 && pb_membersize(NEMSignTx, supply_change) < 65536 && pb_membersize(NEMSignTx, aggregate_modification) < 65536 && pb_membersize(NEMSignTx, importance_transfer) < 65536 && pb_membersize(NEMSignedTx, data) < 65536 && pb_membersize(NEMDecryptMessage, payload) < 65536 && pb_membersize(NEMDecryptedMessage, payload) < 65536 && pb_membersize(StellarPaymentOp, asset) < 65536 && pb_membersize(StellarPathPaymentOp, send_asset) < 65536 && pb_membersize(StellarPathPaymentOp, destination_asset) < 65536 && pb_membersize(StellarPathPaymentOp, paths[0]) < 65536 && pb_membersize(StellarManageOfferOp, selling_asset) < 65536 && pb_membersize(StellarManageOfferOp, buying_asset) < 65536 && pb_membersize(StellarCreatePassiveOfferOp, selling_asset) < 65536 && pb_membersize(StellarCreatePassiveOfferOp, buying_asset) < 65536 && pb_membersize(StellarChangeTrustOp, asset) < 65536 && pb_membersize(DebugLinkState, layout) < 65536 && pb_membersize(DebugLinkState, node) < 65536 && pb_membersize(DebugLinkMemory, memory) < 65536 && pb_membersize(DebugLinkMemoryWrite, memory) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_ClearSession_ApplySettings_ApplyFlags_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_PassphraseStateRequest_PassphraseStateAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_EthereumGetAddress_Address_EthereumAddress_WipeDevice_LoadDevice_ResetDevice_BackupDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_SignMessage_VerifyMessage_MessageSignature_CipherKeyValue_CipheredKeyValue_SignTx_TxRequest_TxAck_EthereumSignTx_EthereumTxRequest_EthereumTxAck_EthereumSignMessage_EthereumVerifyMessage_EthereumMessageSignature_SignIdentity_SignedIdentity_GetECDHSessionKey_ECDHSessionKey_SetU2FCounter_NEMGetAddress_NEMAddress_NEMSignTx_NEMSignedTx_NEMDecryptMessage_NEMDecryptedMessage_CosiCommit_CosiCommitment_CosiSign_CosiSignature_StellarGetPublicKey_StellarPublicKey_StellarSignTx_StellarTxOpRequest_StellarPaymentOp_StellarCreateAccountOp_StellarPathPaymentOp_StellarManageOfferOp_StellarCreatePassiveOfferOp_StellarSetOptionsOp_StellarChangeTrustOp_StellarAllowTrustOp_StellarAccountMergeOp_StellarManageDataOp_StellarBumpSequenceOp_StellarSignedTx_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog_DebugLinkMemoryRead_DebugLinkMemory_DebugLinkMemoryWrite_DebugLinkFlashErase)
#endif
