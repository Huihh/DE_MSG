...
const pb_field_t TxInputType_fields[11] = {
...
const pb_field_t TransactionType_fields[12] = {
	...
	PB_FIELD(11, BOOL    , OPTIONAL, STATIC  , OTHER, TransactionType, overwintered, decred_expiry, 0),
	PB_LAST_FIELD
};
...
const pb_field_t NEMMosaic_fields[4] = {
	PB_FIELD(1, STRING  , OPTIONAL, STATIC  , FIRST, NEMMosaic, namespace1, namespace1, 0),
	PB_FIELD(2, STRING  , OPTIONAL, STATIC  , OTHER, NEMMosaic, mosaic, namespace1, 0),
	PB_FIELD(3, UINT64  , OPTIONAL, STATIC  , OTHER, NEMMosaic, quantity, mosaic, 0),
	PB_LAST_FIELD
};

const pb_field_t NEMProvisionNamespace_fields[5] = {
	PB_FIELD(1, STRING  , OPTIONAL, STATIC  , FIRST, NEMProvisionNamespace, namespace1, namespace1, 0),
	PB_FIELD(2, STRING  , OPTIONAL, STATIC  , OTHER, NEMProvisionNamespace, parent, namespace1, 0),
...
const pb_field_t NEMMosaicDefinition_fields[16] = {
	...
	PB_FIELD(3, STRING  , OPTIONAL, STATIC  , OTHER, NEMMosaicDefinition, namespace1, ticker, 0),
	PB_FIELD(4, STRING  , OPTIONAL, STATIC  , OTHER, NEMMosaicDefinition, mosaic, namespace1, 0),
...
const pb_field_t NEMMosaicSupplyChange_fields[5] = {
	PB_FIELD(1, STRING  , OPTIONAL, STATIC  , FIRST, NEMMosaicSupplyChange, namespace1, namespace1, 0),
	PB_FIELD(2, STRING  , OPTIONAL, STATIC  , OTHER, NEMMosaicSupplyChange, mosaic, namespace1, 0),
...
const pb_field_t StellarAssetType_fields[4] = {
	...
	PB_FIELD(3, BYTES   , OPTIONAL, STATIC  , OTHER, StellarAssetType, issuer, code, 0),
	PB_LAST_FIELD
};
